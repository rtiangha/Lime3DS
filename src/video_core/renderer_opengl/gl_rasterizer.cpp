...
void RasterizerOpenGL::SetupVertexArray(u8* array_ptr, GLintptr buffer_offset,
    ...
    LIME3DS_PROFILE("OpenGL", "Vertex Array Setup");
...
bool RasterizerOpenGL::SetupVertexShader() {
    LIME3DS_PROFILE("OpenGL", "Vertex Shader Setup");
    return shader_manager.UseProgrammableVertexShader(regs, pica.vs_setup);
}

bool RasterizerOpenGL::SetupGeometryShader() {
    LIME3DS_PROFILE("OpenGL", "Geometry Shader Setup");
...
bool RasterizerOpenGL::Draw(bool accelerate, bool is_indexed) {
    LIME3DS_PROFILE("OpenGL", "Drawing");
...
bool RasterizerOpenGL::AccelerateDisplay(const Pica::FramebufferConfig& config,
    ...
    LIME3DS_PROFILE("OpenGL", "Display");
